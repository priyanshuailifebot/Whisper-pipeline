...
# Enable AEC for hybrid echo cancellation (browser + server)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_connection_time',
                        type=int,
                        default=600,
                        help='The maximum duration (in seconds) a client can stay connected. Defaults to 600 seconds (10 minutes)')
